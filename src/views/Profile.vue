            ...
            <div class="grid grid-cols-3 gap-6">
              ...
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 rounded-md shadow-sm flex">
                  ...
                  <input type="text" name="displayname" id="displayname" autocomplete="displayname" class="focus:ring-indigo-500 focus:border-indigo-500 flex-grow block w-full min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300" />
                </div>
              </div>
